...
?><div class="panel-body red">
                        <i class="fa fa-calendar fa-3x"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo htmlentities($totalcat);?> </b><a href="manage-category.php">Total Category</a> 
</div>
                    </div>
                </div>
                <div class="col-lg-4">
...
?><div class="panel-body yellow">
                        <i class="fa  fa-beer fa-3x"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo htmlentities($totalpass);?></b><a href="manage-pass.php"> Total Pass</a>
                    </div>
                    </div>
                </div>
                <div class="col-lg-4">
...
?><div class="panel-body yellow">
                        <i class="fa  fa-pencil fa-3x"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo htmlentities($yes_pass);?></b> <a href="yesterdays-pass.php">Pass Created Yesterday </a>
                    </div>
                    </div>
                </div>
                  <div class="col-lg-4">
...
?><div class="panel-body green">
                        <i class="fa  fa-pencil fa-3x"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo htmlentities($seven_pass);?></b> <a href="last-7days-pass.php">Pass Created in Seven Days</a>
</div>
                    </div>
                </div>
